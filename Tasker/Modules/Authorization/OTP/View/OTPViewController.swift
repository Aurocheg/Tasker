...
final class OTPViewController: UIViewController {
    ...
    private lazy var firstTF = TextField(type: .number, alignment: .center, icon: false)
    private lazy var secondTF = TextField(type: .number, alignment: .center, icon: false)
    private lazy var thirdTF = TextField(type: .number, alignment: .center, icon: false)
    private lazy var fourthTF = TextField(type: .number, alignment: .center, icon: false)
